...
> **Projektstatus:** Implementierungsphase 3A (Fragen-Engine).
> Kein fertiges MVP. Fragen-Engine (dynamische Fragebögen mit
> Sichtbarkeitslogik, Versionierung, Tenant-Isolation) ist implementiert
> und getestet; weiterhin **keine** Empfehlungs-Engine, kein
> Cross-Selling, keine fertige Mitarbeiteroberfläche, keine echten
> Kundendaten. Siehe
...
Telekom, Freenet). Bisher umgesetzt: Projektgerüst, vollständiges
Datenmodell, Migrationen, synthetisches Seed-Skript, Mandantentrennung samt
Sicherheitstests, eine interne technische Prüfansicht, eine CI-Pipeline
sowie (Phase 3A) die serverseitige Fragen-Engine
(`src/server/questionnaire/`, siehe
[docs/QUESTION_ENGINE.md](docs/QUESTION_ENGINE.md)) – **nicht** die
Empfehlungs-Engine oder eine fertige Mitarbeiteroberfläche.
...
| [docs/QUESTION_ENGINE.md](docs/QUESTION_ENGINE.md)                 | Fragen-Engine (Phase 3A): implementiertes Verhalten, nicht nur Konzept              |
