...
Kein Test in diesem Repository prüft Fragen-Engine, Empfehlungs-Engine
oder eine Mitarbeiteroberfläche – diese Bausteine sind nicht Teil dieser
Implementierungsphase (siehe [IMPLEMENTATION_STATUS.md](IMPLEMENTATION_STATUS.md)).
