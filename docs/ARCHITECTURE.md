...
| Reaktionsgeschwindigkeit während Gespräch | Fragen-Engine läuft primär clientseitig auf bereits geladenem Regelwerk der aktuellen Fragebogen-Version; kein Server-Rundruf pro Frage nötig |
